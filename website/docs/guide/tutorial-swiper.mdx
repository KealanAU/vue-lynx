...
The carousel responds to touch, so the web preview below demonstrates it for you: the swipes are simulated, and the circle marks where a finger would be. Touch or click the preview at any time and it hands control straight back to you.
...
The demonstration swipes this one too, and nothing moves — that is the point. Nothing here listens for the gesture yet.
